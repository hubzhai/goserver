...
import (
	"github.com/idealeak/goserver.v3/core/builtin/action"
	"github.com/idealeak/goserver.v3/core/builtin/protocol"
	"github.com/idealeak/goserver.v3/core/logger"
	"github.com/idealeak/goserver.v3/core/netlib"
	"github.com/idealeak/goserver.v3/core/transact"
)
...
func init() {
	transact.RegisteTxCommSkeleton("github.com/idealeak/goserver.v3/srvlib/txcommskeleton", &TxCommSkeleton{})
}
